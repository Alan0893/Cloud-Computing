...
SUBSCRIPTION_ID = os.environ.get("SUBSCRIPTION_ID", "forbidden-sub")
...
def start_pubsub_listener():
    ...
    try:
        ...
        print(f"Pub/Sub listener error: {exc}", flush=True)
...
def forbidden():
    ...
    path = data.get("path", "/")
    print(f"[FORBIDDEN ACCESS via HTTP] Country: {country}, Path: {path}", flush=True)
